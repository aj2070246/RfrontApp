        ...
        <Paper elevation={3} sx={{ p: 4, borderRadius: 2 }}>
          <form onSubmit={handleSubmit}>
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                <Link legacyBehavior href="/login" variant="body2">بازگشت به صفحه ورود به سامانه</Link>
                <br />
                <Link legacyBehavior href="/ForgatePassword" variant="body2">بازیابی رمز عبور</Link>
              </Grid>
